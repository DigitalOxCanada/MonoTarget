...
namespace MonoTarget
{
    ...
    public class Game1 : Game
    {
        ...
        public HitLabelManager HitLabelManager;
        public RicochetManager ricoManager;
        ...
        public Game1()
        {
            ...
            HitLabelManager = new HitLabelManager();
            PointsLabelManager = new PointsLabelManager();
            ricoManager = new RicochetManager();
        ...
        protected override void LoadContent()
        {
            ...
            HitLabelManager.Initialize(this, spriteSheetLoader, "hitlabels1.png");
            PointsLabelManager.Initialize(this, "Playbill");
            ricoManager.Initialize(this, spriteSheetLoader, "Ricochet.png");
