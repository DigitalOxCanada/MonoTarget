...
namespace MonoTarget
{
    ...
    public class HitLabel : GameObject
    {
        ...
        public override void Initialize(Game1 game, string tex=null, float X = 0.0f, float Y = 0.0f)
        {
            base.Initialize(game, null, X, Y);
