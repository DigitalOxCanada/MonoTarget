...
namespace MonoTarget
{
    ...
    {
        //TODO make animation & spritesheet of barber pole
        //TODO new bgmaterial color for hit testing for barber pole
        //TODO speed up barber pole when hit, slowing back to normal speed over 3 seconds.
        ...
        int characterVelocityPixelsPerSecond;
        ...
        protected override void Initialize()
        {
            ...
            characterStartPosition = new Vector2(GraphicsDevice.Viewport.Width / 10,
                                     GraphicsDevice.Viewport.Height * 0.8f);
            characterVelocityPixelsPerSecond = GraphicsDevice.Viewport.Width / 4;

            var spriteSheetLoader = new SpriteSheetLoader(Content, GraphicsDevice);
            testSpriteSheet = spriteSheetLoader.Load("walk.png");

            var walkSprites = new[] {
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0001,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0002,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0003,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0004,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0005,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0006,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0007,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0008,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0009,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0010,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0011,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0012,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0013,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0014,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0015,
                TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0016
            };
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //spriteRender.Draw(testSpriteSheet.Sprite(TexturePackerMonoGameDefinitions.WalkAnim.WalkAnim_0001),
            //        new Vector2(350, 350));
