...
namespace MonoTarget
{
    public class HUD : GameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                if(new Rectangle(new Point((int)AmmoPosition.X, (int)AmmoPosition.Y), new Point(ReloadButtonTexture.Width, ReloadButtonTexture.Height)).Contains(_gameplayScreen.CurrentMouseState.Position))
                {
