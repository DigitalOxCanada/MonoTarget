    ...
    public class BulletManager
    {
        ...
        public Bullet MakeNewBullet(Vector2 position)
        {
            ...
            foreach (var b in bullets)
            {
                ...
                if (!b.IsActive)
                {
                    b.Position = new Vector2 { X = _gameplayScreen.ScreenManager.input.CurrentMouseState.X - b.Texture.Width / 2, Y = _gameplayScreen.ScreenManager.input.CurrentMouseState.Y - b.Texture.Height / 2 };
                    b.IsActive = true;
                    return b;
                }
            }
