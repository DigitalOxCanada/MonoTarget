...
namespace GameStateManagement
{
    ...
    class BackgroundScreen : GameScreen
    {
        ...
        Rectangle oxlogorect;
        private int oxlogohit;
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            oxlogorect = new Rectangle((int)oxlogo.Position.X-(int)oxlogo.Origin.X, (int)oxlogo.Position.Y-(int)oxlogo.Origin.Y, (int)oxlogo.Size.X, (int)oxlogo.Size.Y);

            if (oxlogorect.Contains(ScreenManager.input.CurrentMouseState.Position))
            {
                //if (ScreenManager.input.LeftMouseButtonClicked)
                //{
                //    oxlogohit++;
                //    if (oxlogohit > 6)
                //    {
                //        oxlogohit = 0;
                //        ScreenManager.SoundManager.PlaySound("digitalox");
                //    }
                //    else
                //    {
