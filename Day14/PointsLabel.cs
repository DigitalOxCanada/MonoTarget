...
namespace MonoTarget
{
    ...
    public class PointsLabel : GameObject
    {
        ...
        private Color PointsBackColor = Color.Black;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (IsActive)
            {
                ...
                spriteBatch.DrawString(_mgr.spriteFont, _text, Position + new Vector2(1 * scale, 1 * scale), PointsBackColor * TransitionAlpha, Rotation, Origin, scale, SpriteEffects.None, 0);
                spriteBatch.DrawString(_mgr.spriteFont, _text, Position + new Vector2(-1 * scale, 1 * scale), PointsBackColor * TransitionAlpha, Rotation, Origin, scale, SpriteEffects.None, 0);
                spriteBatch.DrawString(_mgr.spriteFont, _text, Position + new Vector2(-1 * scale, -1 * scale), PointsBackColor * TransitionAlpha, Rotation, origin, scale, SpriteEffects.None, 1f);
                spriteBatch.DrawString(_mgr.spriteFont, _text, Position + new Vector2(1 * scale, -1 * scale), PointsBackColor * TransitionAlpha, Rotation, origin, scale, SpriteEffects.None, 1f);          

                spriteBatch.DrawString(_mgr.spriteFont, _text, Position, PointsColor * TransitionAlpha, Rotation, origin, scale, SpriteEffects.None, 0f);
            }
        }
