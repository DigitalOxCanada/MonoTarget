...
namespace MonoTarget
{
    public class BarberPole : BackgroundHitObject
    {
        ...
        public BarberPole(GameplayScreen gameplayScreen)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Size = barberPoleAnimationManager.CurrentSprite.Size;
        }
        ...
        public override void Hit()
        {
            ...
            _gameplayScreen.player.Score += 5;
            _gameplayScreen.PointsLabelManager.CreatePointsLabel($"+5", (int)Position.X + (this.Texture.Width / 2), (int)Position.Y - 25);
        }
