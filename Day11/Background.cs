...
namespace MonoTarget
{
    public class Background : GameObject
    {
        ...
        private void ShotBuilding()
        {
            ...
            _gameplayScreen.ScreenManager.SpriteBatch.Draw(b.Texture, new Vector2(_gameplayScreen.CurrentMouseState.X, _gameplayScreen.CurrentMouseState.Y)-b.Origin, Color.White);
